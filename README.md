...
The intention with `shapemaker` is to do as much work as possible in automated workflows. However, `shapemaker` offers a lot of nifty shell commands you can use on the fly. Some of these functions are put on display in the video below. *Click to watch*.
